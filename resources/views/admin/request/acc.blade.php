...
<head>
    <title>Show Accept Request</title>
    <meta charset="UTF-8">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{Route('admin-requests.index')}}">Show Accept Request</a></li>
                            </ul>
                        </div>
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h2 class="mb-0">Show Accept Request</h2>
                            </div>
                        </div>
                    </div>
                </div>
